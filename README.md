...
- [new]: rainbow: Add the large language model (LLM) feature (MediaPipe4ULLM plugin) to support offline deployment and inference llama2 model ([Document](https://opensource.labijie.com/Mediapipe4u-plugin/llm/)).   
