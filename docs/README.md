...
- [English (sorry it's google translate)](https://translate.google.com/translate?sl=zh-CN&tl=en&hl=zh-CN&u=https://opensource.labijie.com/Mediapipe4u-plugin/README.html&client=webapp)

- [日本語 (申し訳ありませんが、それは単なるGoogle翻訳です)](https://translate.google.com/translate?sl=zh-CN&tl=ja&hl=zh-CN&u=https://opensource.labijie.com/Mediapipe4u-plugin/README.html&client=webapp)

- [한국어 (죄송합니다, 이것은 단지 구글 번역입니다)](https://translate.google.com/translate?sl=zh-CN&tl=ko&hl=zh-CN&u=https://opensource.labijie.com/Mediapipe4u-plugin/README.html&client=webapp)
